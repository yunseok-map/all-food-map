        ...
        <div class="details">
            <div class="p-2 space-y-4">
                ...
                <div class="review-section border-t theme-border pt-4 mt-4">
                    <div class="review-section-header flex justify-between items-center cursor-pointer">
                        <h4 class="font-bold theme-text-strong">한줄평</h4>
                        <svg class="review-toggle-icon w-5 h-5 transition-transform transform theme-text-body" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                    </div>
